...
from scoring import compute_composite_score, flag_zones, extract_zone_transitions
...
def run_basic_backtest(weights: dict = None, sell_threshold: float = 75, buy_threshold: float = 25):
    ...
    print(f"Total zone transitions: {len(transitions)}  (~{signals_per_year:.1f}/year)")
    print()
